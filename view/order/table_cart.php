                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 col-md-3 col-lg-3">
                            ...
                            <div class="input-group input-spinner">
                                <input type="button" value="-" onclick="btnMinus(this, <?= $id ?>, <?= $key ?>)" class="button-minus btn btn-sm" data-field="quantity" />
                                <input type="number" min="1" max="<?= $quantity ?>" value="<?= $quantityOrder ?>" name="quantity" class="quantity-field form-control-sm form-input" />
                                <input type="button" value="+" onclick="btnPlus(this, <?= $id ?>, <?= $key ?>)" class="button-plus btn btn-sm" data-field="quantity" />
                            </div>
                        </div>
                        <!-- price -->
