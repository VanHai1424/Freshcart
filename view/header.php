            ...
            <div class="container">
                <div class="row w-100 align-items-center gx-lg-2 gx-0">
                    ...
                    <div class="col-xxl-5 col-lg-5 d-none d-lg-block">
                        <form method="POST" action="index.php?act=categories">
                            <div class="input-group">
                                <input name="keyw" class="form-control rounded" type="search" placeholder="Search for products" />
                                <span class="input-group-append">
                                    <button name="submit" class="btn bg-white border border-start-0 ms-n10 rounded-0 rounded-end" type="submit">
                    ...
                    <div class="col-lg-2 col-xxl-2 text-end col-md-6 col-7">
                        <div class="list-inline">
                            <div class="list-inline-item me-5 ">
                                <a class="text-muted position-relative" data-bs-target="#offcanvasRight" href="index.php?act=cart" role="button" aria-controls="offcanvasRight">
                            ...
                            <div class="collapse mt-2" id="collapseExample">
                                <div class="card card-body">
                                    <ul class="mb-0 list-unstyled">
                                        <li><a class="dropdown-item" href="index.php?act=categories">Dairy, Bread & Eggs</a></li>
                                        <li><a class="dropdown-item" href="index.php?act=categories">Snacks & Munchies</a></li>
                                        <li><a class="dropdown-item" href="index.php?act=categories">Fruits & Vegetables</a></li>
                                        <li><a class="dropdown-item" href="index.php?act=categories">Cold Drinks & Juices</a></li>
                                        <li><a class="dropdown-item" href="index.php?act=categories">Breakfast & Instant Food</a></li>
                                        <li><a class="dropdown-item" href="index.php?act=categories">Bakery & Biscuits</a></li>
                                        <li><a class="dropdown-item" href="index.php?act=categories">Chicken, Meat & Fish</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div> -->
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <?php 
                                    foreach ($listCategory as $value) {
                                        extract($value);
                                        echo '<li><a class="dropdown-item" href="index.php?act=categories&id='.$id.'">'.$name.'</a></li>';
                                    }
                                ?>
                                <!-- <li><a class="dropdown-item" href="index.php?act=categories">Dairy, Bread & Eggs</a></li>
                                <li><a class="dropdown-item" href="index.php?act=categories">Snacks & Munchies</a></li>
                        ...
                        <div>
                            ...
                            <div class="dropdown-menu pb-0">
                                ...
                                <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                                    ...
                                    <a class="dropdown-item" href="index.php?act=categories">Butter</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Milk Drinks</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Curd & Yogurt</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Eggs</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Buns & Bakery</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Cheese</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Condensed Milk</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Dairy Products</a>
                                </div>
                                <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                                    <h6 class="text-primary ps-3">Breakfast & Instant Food</h6>
                                    <a class="dropdown-item" href="index.php?act=categories">Breakfast Cereal</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Noodles, Pasta & Soup</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Frozen Veg Snacks</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Frozen Non-Veg Snacks</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Vermicelli</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Instant Mixes</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Batter</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Fruit and Juices</a>
                                </div>
                                <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                                    <h6 class="text-primary ps-3">Cold Drinks & Juices</h6>
                                    <a class="dropdown-item" href="index.php?act=categories">Soft Drinks</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Fruit Juices</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Coldpress</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Water & Ice Cubes</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Soda & Mixers</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Health Drinks</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Herbal Drinks</a>
                                    <a class="dropdown-item" href="index.php?act=categories">Milk Drinks</a>
                                </div>
                                <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                                ...
                                <li class="nav-item dropdown w-100 w-lg-auto dropdown-flyout">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-lg" aria-labelledby="navbarDropdownDocs">
                                        <a class="dropdown-item align-items-start" href="/freshcart/docs/index.html">
                                            <div>
                                        ...
                                        <a class="dropdown-item align-items-start" href="/freshcart/docs/changelog.html">
                                            <div>
                                ...
                                <!-- <li class="nav-item dropdown w-100 w-lg-auto">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="index.php?act=signin">Sign in</a></li>
                                        <li><a class="dropdown-item" href="index.php?act=signup">Signup</a></li>
                                        <li><a class="dropdown-item" href="index.php?act=forgot_pass">Forgot Password</a></li>
