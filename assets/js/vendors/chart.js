...
window.theme = theme,
    function () {
        "use strict";
        var e;
        document.getElementById("revenueChart") && (e = {
            series: [{
                name: "Total Income",
        ...
        }, new ApexCharts(document.getElementById("revenueChart"), e).render()), document.getElementById("totalSale") && (e = {
            series: JSON.parse(document.getElementById("totalSale").getAttribute("data-series")).map(Number),
            labels: JSON.parse(document.getElementById("totalSale").getAttribute("data-label")),
            colors: ["#0aad0a", "#ffc107", "#db3030", "#016bf8", "#6610f2", "#d63384", "#fd7e14", "#581313"],
            chart: {
                type: "donut",
                height: 280
            },
