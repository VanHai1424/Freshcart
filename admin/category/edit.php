            ...
            <div class="row mb-8">
                <div class="col-md-12">
                    <div class="d-md-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="index.php?act=list_category" class="btn btn-light">Back to Category</a>
                        </div>
                    </div>
                </div>
            </div>
            <form action="index.php?act=update_category" method="POST" class="row" enctype="multipart/form-data">
