            ...
            <div class="row mb-8">
                <div class="col-md-12">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-4">
                        ...
                        <!-- button -->
                        <div>
                            <a href="index.php?act=add_category" class="btn btn-primary">Add New Category</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <table class="table table-centered table-hover mb-0 text-nowrap table-borderless table-with-checkbox">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#!"><img src="../upload/<?= $img ?>" alt="" class="icon-shape icon-sm" /></a>
                                            </td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a onclick="return confirm('Bạn có chắc xóa không')" class="dropdown-item" href="index.php?act=delete_category&id=<?= $id ?>">
                                                                <i class="bi bi-trash me-3"></i>
                                                                Delete
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="index.php?act=edit_category&id=<?= $id ?>">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item" href="index.php?act=edit_category">
                                                                <i class="bi bi-pencil-square me-3"></i>
                                                                Edit
                                                            </a>
                                                        </li>
