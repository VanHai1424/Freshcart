                                ...
                                <table class="table table-centered table-hover table-borderless mb-0 table-with-checkbox text-nowrap">
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a onclick="return confirm('Bạn có chắc xóa không')"  class="dropdown-item" href="index.php?act=delete_review&id=<?= $id ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-truncate">Excellent Quality by an Indian
                                                    company..</span>
                                            </td>
                                            <td>
                                                <div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-truncate">Very expensive. Cheaper at local
                                                    stores...</span>
                                            </td>
                                            <td>
                                                <div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-truncate">is good but had to wait for a late
                                                    delivery.</span>
                                            </td>
                                            <td>
                                                <div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-truncate">My toddler loved the flavor and
                                                    enjoys...</span>
                                            </td>
                                            <td>
                                                <div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-truncate">Good Product but packaging
                                                    needs...</span>
                                            </td>
                                            <td>
                                                <div>
