<?php 
	if(is_array($statistics)) {
		...
		foreach ($listTotalSold as $value) {
			$labelsData[] = $value['category_name'];
			$seriesData[] = $value['total_sold'];
		}
	} 
?>
				...
				<div class="col-md-12">
					...
					<div class="card bg-light border-0 rounded-4" style="background-image: url(../assets/images/slider/slider-image-1.jpg); background-repeat: no-repeat; background-size: cover; background-position: right">
						<div class="card-body p-lg-12">
							...
							<a href="index.php?act=add_product" class="btn btn-primary">Create Product</a>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="col-lg-4 col-12 mb-6">
						...
						<div class="card h-100 card-lg">
							...
							<div class="card-body p-6">
								...
								<!-- project number -->
								<div class="lh-1">
									<h1 class="mb-2 fw-bold fs-2"><?= number_format($total_income) ?> VND</h1>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-12 mb-6">
						...
						<div class="card h-100 card-lg">
							...
							<div class="card-body p-6">
								...
								<!-- project number -->
								<div class="lh-1">
									<h1 class="mb-2 fw-bold fs-2"><?= number_format($total_order) ?></h1>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-12 mb-6">
						...
						<div class="card h-100 card-lg">
							...
							<div class="card-body p-6">
								...
								<!-- project number -->
								<div class="lh-1">
									<h1 class="mb-2 fw-bold fs-2"><?= number_format($total_user) ?></h1>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-xl-4 col-lg-6 col-12 mb-6">
					...
					<div class="card h-100 card-lg">
						...
						<div class="card-body p-6">
							...
							<div id="totalSale" data-series=<?= json_encode($seriesData) ?> data-label=<?= json_encode($labelsData) ?> class="mt-6 d-flex justify-content-center"></div>
							<div class="mt-4">
								<!-- list -->
								<ul class="list-unstyled mb-0">
									...
									<li class="mb-2">
										<span class="ms-1">
											<span class="text-dark"><?= $category_name ?>: <?= $total_sold ?></span>
										</span>
									</li>
									<?php 
										}
