<div class="main-wrapper">
    ...
    <main class="main-content-wrapper">
        ...
        <div class="container">
            ...
            <!-- row -->
            <form action="index.php?act=update_product" method="POST" class="row" enctype="multipart/form-data">
                        ...
                        <div class="card-body p-6">
                            ...
                            <div class="mb-4 d-flex">
                                <div class="position-relative">
                                    <img class="image icon-shape icon-xxxl bg-light rounded-4" src="../upload/<?= $img ?>" alt="Image" />
                            ...
                            <div class="row">
                                    ...
                                    <select class="form-select" name="id_category">
                                        ...
                                        <?php 
                                            foreach ($listCategory as $value) {
                                                echo '<option '.(($value['id'] == $id_category) ? 'selected' : '').' value="'.$value['id'].'">'.$value['name'].'</option>';
                                            }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3 col-lg-12 mt-5">
                                    ...
                                    <textarea name="desc" id="" cols="93" rows="6" class="form-control"><?= $desc ?></textarea>
